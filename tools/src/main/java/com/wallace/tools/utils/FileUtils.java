...
//    public static ArrayList<MusicInfo> musicFiles(File dir) {
//            ArrayList<MusicInfo> songs = new ArrayList<>();
...
//                });
//                for (File file : files) {
//                    MusicInfo song = fileToMusic(file);
//                    if (song != null) {
//                        songs.add(song);
//                    }
//                }
//            }
//        if (songs.size() > 1) {
//            Collections.sort(songs, new Comparator<MusicInfo>() {
//                @Override
//                public int compare(MusicInfo left, MusicInfo right) {
...
//    }
    ...
    public static MusicInfo fileToMusic(Context context,File file) {
