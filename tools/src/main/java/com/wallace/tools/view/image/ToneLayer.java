...
public class ToneLayer {
    ...
    private void init(Context context) {
      ...
      饱和度
     */
        TextView mSaturation = new TextView(context);
        mSaturation.setText("饱和度");
        /*
      色相
     */
        TextView mHue = new TextView(context);
        mHue.setText("色相");
        /*
      亮度
     */
        TextView mLum = new TextView(context);
        mLum.setText("亮度");

        SeekBar mSaturationBar = new SeekBar(context);
        SeekBar mHueBar = new SeekBar(context);
        SeekBar mLumBar = new SeekBar(context);
